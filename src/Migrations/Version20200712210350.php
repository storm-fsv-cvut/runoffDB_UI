 ...
 */
final class Version20200712210350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE run DROP rain_intensity_mesurement_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE run ADD rain_intensity_mesurement_id INT DEFAULT NULL');
