...
final class Version20201019210847 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE run_group (id INT AUTO_INCREMENT NOT NULL, run_type_id INT NOT NULL, sequence_id INT NOT NULL, datetime DATE NOT NULL, preceding_precipitation DOUBLE PRECISION DEFAULT NULL, note_cz LONGTEXT NOT NULL, note_en LONGTEXT DEFAULT NULL, INDEX IDX_515F5E4B9D2EFCB3 (run_type_id), INDEX IDX_515F5E4B98FB19AE (sequence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
