 ...
 */
final class Version20191215220654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE data (id INT AUTO_INCREMENT NOT NULL, record_id INT NOT NULL, time TIME DEFAULT NULL, value VARCHAR(255) NOT NULL, related_value DOUBLE PRECISION DEFAULT NULL, INDEX IDX_ADF3F3634DFD750C (record_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE measurement (id INT AUTO_INCREMENT NOT NULL, run_id INT NOT NULL, description_cz VARCHAR(255) DEFAULT NULL, description_en VARCHAR(255) DEFAULT NULL, note_cz VARCHAR(255) DEFAULT NULL, note_en VARCHAR(255) DEFAULT NULL, INDEX IDX_2CE0D81184E3FEC4 (run_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE record (id INT AUTO_INCREMENT NOT NULL, measurement_id INT NOT NULL, record_type_id INT NOT NULL, unit_id INT NOT NULL, related_value_unit_id INT DEFAULT NULL, note_cz VARCHAR(255) DEFAULT NULL, note_en VARCHAR(255) DEFAULT NULL, is_timeline TINYINT(1) NOT NULL, INDEX IDX_9B349F91924EA134 (measurement_id), INDEX IDX_9B349F9172938CEE (record_type_id), INDEX IDX_9B349F91F8BD700D (unit_id), INDEX IDX_9B349F91FB4DCFF2 (related_value_unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE record ADD CONSTRAINT FK_9B349F91FB4DCFF2 FOREIGN KEY (related_value_unit_id) REFERENCES unit (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE record DROP FOREIGN KEY FK_9B349F91FB4DCFF2');
