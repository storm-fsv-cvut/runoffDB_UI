 ...
 */
final class Version20191117125925 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE crop (id INT AUTO_INCREMENT NOT NULL, crop_type_id INT DEFAULT NULL, name_cz VARCHAR(50) NOT NULL, name_en VARCHAR(50) DEFAULT NULL, variety VARCHAR(100) DEFAULT NULL, note VARCHAR(500) DEFAULT NULL, INDEX IDX_EDC23D9B863EBD0A (crop_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE crop_type (id INT AUTO_INCREMENT NOT NULL, name_cz VARCHAR(50) NOT NULL, name_en VARCHAR(50) DEFAULT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE locality (id INT AUTO_INCREMENT NOT NULL, organization_id INT DEFAULT NULL, soil_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, lat DOUBLE PRECISION NOT NULL, lng DOUBLE PRECISION NOT NULL, note VARCHAR(500) DEFAULT NULL, INDEX IDX_E1D6B8E632C8A3DE (organization_id), INDEX IDX_E1D6B8E6A8AE1818 (soil_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE measurement (id INT AUTO_INCREMENT NOT NULL, run_id INT NOT NULL, is_timeline TINYINT(1) NOT NULL, description_cz VARCHAR(255) DEFAULT NULL, description_en VARCHAR(255) DEFAULT NULL, note_cz VARCHAR(255) DEFAULT NULL, note_en VARCHAR(255) DEFAULT NULL, INDEX IDX_2CE0D81184E3FEC4 (run_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE organization (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, contact_person VARCHAR(255) DEFAULT NULL, contact_number VARCHAR(10) DEFAULT NULL, contact_email VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE soil_sample (id INT AUTO_INCREMENT NOT NULL, processed_at_id INT DEFAULT NULL, texture_id INT DEFAULT NULL, plot_id INT DEFAULT NULL, soil_type_id INT DEFAULT NULL, locality_id INT DEFAULT NULL, date_sampled DATE NOT NULL, corg DOUBLE PRECISION DEFAULT NULL, bulk_density DOUBLE PRECISION DEFAULT NULL, sample_location VARCHAR(500) DEFAULT NULL, moisture_gkg DOUBLE PRECISION DEFAULT NULL, note VARCHAR(500) DEFAULT NULL, INDEX IDX_CE7B16D69A37EDDE (processed_at_id), INDEX IDX_CE7B16D6204BC3AC (texture_id), INDEX IDX_CE7B16D6680D0B01 (plot_id), INDEX IDX_CE7B16D6A8AE1818 (soil_type_id), INDEX IDX_CE7B16D688823A92 (locality_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE soil_type (id INT AUTO_INCREMENT NOT NULL, soil_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE value (id INT AUTO_INCREMENT NOT NULL, name_cz VARCHAR(255) DEFAULT NULL, name_en VARCHAR(255) DEFAULT NULL, unit VARCHAR(255) NOT NULL, description_cz VARCHAR(255) DEFAULT NULL, description_en VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE locality ADD CONSTRAINT FK_E1D6B8E6A8AE1818 FOREIGN KEY (soil_type_id) REFERENCES soil_type (id)');
        ...
        $this->addSql('ALTER TABLE record ADD CONSTRAINT FK_9B349F91F920BBA2 FOREIGN KEY (value_id) REFERENCES value (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE locality DROP FOREIGN KEY FK_E1D6B8E6A8AE1818');
        $this->addSql('ALTER TABLE soil_sample DROP FOREIGN KEY FK_CE7B16D6A8AE1818');
